...
;layui.define("view", function (e) {
    var a = layui.jquery, t = layui.laytpl, i = layui.element, n = layui.setter, l = layui.view, s = layui.device(),
        ...
        g = "layadmin-side-shrink", x = "LAY-system-side-menu", C = {
            v: "2020 pro", req: l.req, exit: l.exit, escape: function (e) {
            ...
            flexible: function (e) {
                ...
                a.ajax({
                    type: "get",
                    dataType: "jsonp",
                    data: {name: "layuiAdmin", version: C.v},
                    url: "https://fly.layui.com/api/product_update/",
                    success: function (e) {
                        0 === e.status ? e.version === C.v.replace(/\s|pro|std/g, "") ? layer.alert("当前版本已经是最新版本") : layer.alert("检查到更新，是否前往下载？", {btn: ["更新", "暂不"]}, function (e) {
    ...
    o.on("click", z, function () {
        ...
        var e = a(this), t = e.attr("lay-href"), i = layui.router();
        C.tabsPage.elem = e, location.hash = C.correctRouter(t), C.correctRouter(t) === i.href && C.events.refresh()
